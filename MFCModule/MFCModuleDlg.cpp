...
BEGIN_MESSAGE_MAP(CMFCModuleDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
// CMFCModuleDlg 消息处理程序

BOOL CMFCModuleDlg::OnInitDialog()
{
...
void CMFCModuleDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMFCModuleDlg::OnQueryDragIcon()
{
